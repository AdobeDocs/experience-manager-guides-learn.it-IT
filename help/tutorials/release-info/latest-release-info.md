...
[!DNL Adobe Experience Manager Guides] è un’applicazione implementata nell’AEM. Si tratta di una potente soluzione di gestione dei contenuti per componenti di livello enterprise (CCMS) che consente il supporto DITA nativo in Adobe Experience Manager, consentendo all&#39;AEM di gestire la creazione e la distribuzione di contenuti basati su DITA.
...
Rivolgiti al tuo Customer Success Manager per convalidare il percorso di aggiornamento.
