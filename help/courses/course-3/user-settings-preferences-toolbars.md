...
2. Fai clic sul pulsante [!UICONTROL **Sblocca**] icona.
...
2. Nella finestra di dialogo Inserisci carattere speciale digitare il nome del carattere nella barra di ricerca.
...
3. Seleziona il carattere desiderato.
...
2. Nella finestra di dialogo Preferenze utente, fai clic sul pulsante [!UICONTROL **Tema**] a discesa.
...
2. Nella finestra di dialogo Preferenze utente, fai clic sul pulsante [!UICONTROL **Cartella**] accanto al percorso di base.

   ![Percorso cartella di base](images/lesson-2/base-path-folder-icon.png)

3. Nella finestra di dialogo Seleziona percorso , fai clic sulla casella di controllo accanto a una cartella specifica.
...
2. Nella finestra di dialogo Preferenze utente, fai clic sul pulsante [!UICONTROL **Profili cartella**] a discesa.

   ![Elenco profili](images/lesson-2/folder-profiles-dropdown.png)

3. Scegli un profilo dalle opzioni disponibili.
...
2. Nella finestra di dialogo Impostazioni editor, fai clic sul pulsante [!UICONTROL **Generale**] scheda .

3. Selezionare il dizionario da utilizzare.
...
2. Nella finestra di dialogo Impostazioni editor, fai clic sul pulsante [!UICONTROL **Pannelli**] scheda .

3. Passa i pannelli disponibili da Mostra o Nascondi come necessario.
...
2. Nella finestra di dialogo Impostazioni editor, fai clic sul pulsante [!UICONTROL **Elenco elementi**] scheda .

3. Digita un **Nome elemento** e **Etichetta** nei rispettivi campi.

4. Fai clic sul pulsante [!UICONTROL **Plus**] per aggiungere altri elementi all’elenco.
...
2. Nella finestra di dialogo Impostazioni editor, fai clic sul pulsante [!UICONTROL **Elenco attributi**] scheda .

3. Digita un **Nome attributo** e **Etichetta** nei rispettivi campi.

4. Fai clic sul pulsante [!UICONTROL **Plus**] per aggiungere altri attributi all’elenco.
...
2. Nella finestra di dialogo Impostazioni editor, fai clic sul pulsante [!UICONTROL **Condizione**] scheda .

3. Selezionare le caselle di controllo delle condizioni da applicare.
...
2. Nella finestra di dialogo Impostazioni editor, fai clic sul pulsante [!UICONTROL **Profili**] scheda .

3. Fai clic sul pulsante [!UICONTROL **Plus**] accanto a Profili .

4. Compilare i campi come richiesto.
