...
Sono disponibili diversi predefiniti di output tra cui scegliere. Questa guida si concentrerà sugli output del sito AEM e di PDF.
...
1. Nella scheda Predefiniti di output, seleziona Sito AEM e PDF.
...
Nell’output del sito AEM, gli argomenti, gli elenchi, le immagini, i titoli, le tabelle e gli altri contenuti creati con l’editor XML vengono pubblicati automaticamente in contenuti adatti al Web da AEM.
